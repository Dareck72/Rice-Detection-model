...
model=models.Sequential([
    ...
    #  Ce sont les couches de classification que nous allons entrainer pour notre tâche de classification de 5 classes de riz
...
model.save("Model_ofInceptionV3.keras")

accuracy= model.history.history['accuracy'].max()
